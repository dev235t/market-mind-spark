      ...
      <header className="border-b bg-card transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-md bg-brand flex items-center justify-center animate-pulse-slow">
            ...
            <div className="animate-fade-in">
              <h1 className="text-xl font-bold text-foreground transition-colors duration-300">Market Mind Spark</h1>
              <p className="text-xs text-muted-foreground transition-colors duration-300">AI-powered market research assistant</p>
            </div>
          </div>
        </div>
      </header>
